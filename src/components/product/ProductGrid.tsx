        ...
        return (
          ...
          >
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <p className="font-serif italic text-base text-[#6B6B6B] max-w-md">
                Descubra nossa seleção de {group.label.toLowerCase()} com
                designs modernos e acabamento de qualidade.
              </p>
            </div>
