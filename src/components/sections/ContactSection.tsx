...
export default function ContactSection() {
  return (
    <section id="contato" className="bg-[#FDF8F0] py-24 md:py-36 relative scroll-mt-20">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="text-center space-y-4 mb-16">
          <h2 className="font-display text-3xl sm:text-4xl text-[#1A1A1A] font-medium tracking-tight">
            Fale com a <span className="font-serif italic font-light text-[#E8A020]">Gente</span>
          </h2>
          <p className="font-serif italic text-sm sm:text-sm text-[#6B6B6B] max-w-sm mx-auto">
