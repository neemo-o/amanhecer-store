...
export default function FeaturedCollection() {
  return (
    <section id="colecoes" className="bg-[#FDF8F0] py-24 md:py-36 overflow-hidden border-y border-[#E8E0D0] relative">
      {/* Decorative luxury abstract elements */}
      <div className="absolute left-[30%] top-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[#E8A020]/3 rounded-full blur-[140px] pointer-events-none" />

      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        
        {/* Section title */}
        <div className="text-center space-y-4 mb-24">
          <span className="font-poppins text-sm tracking-[0.3em] uppercase text-[#E8A020] font-semibold flex items-center justify-center gap-2">
            <Sparkles className="w-4 h-4 animate-spin-slow" />
            Curadoria Especial
          </span>
          <h2 className="font-display text-3xl sm:text-4xl md:text-5xl text-[#1A1A1A] font-medium tracking-tight">
            Coleções de <span className="font-serif italic font-light text-[#E8A020]">Destaque</span>
          </h2>
              ...
              >
                ...
                >
                  <div className="space-y-3">
                    <span className="font-poppins text-sm sm:text-sm tracking-[0.3em] uppercase text-[#E8A020] font-semibold">
                      {item.tag}
                    </span>
                  ...
                  <blockquote className="border-l-2 border-[#E8A020] pl-5 py-1">
                  ...
                  <div className="pt-4">
                    <a
                      href="#categorias"
                      className="inline-flex items-center space-x-3 text-sm uppercase tracking-widest font-semibold text-[#E8A020] hover:text-[#F0A830] transition-colors duration-300 group/link"
                    >
